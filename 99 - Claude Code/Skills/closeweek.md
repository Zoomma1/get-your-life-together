...
2. Lire daily notes de la semaine dans `{VAULT_PATH}\{DAILY_NOTES_FOLDER}\` (fichiers `YYYY-MM-DD.md` dans plage lundi-dimanche cible)
   - Extraire du frontmatter de chaque note : `energy`, `score`, `ressenti` (si présents) → stocker pour section Énergie (Étape 3)
...
| Jour | Énergie | Score | Ressenti |
|------|---------|-------|---------|
| Lun | [X]/5 | [X]/5 | *[ressenti]* |
| Mar | ... | ... | ... |
| Mer | ... | ... | ... |
| Jeu | ... | ... | ... |
| Ven | ... | ... | ... |
| Sam | ... | ... | ... |
| Dim | ... | ... | ... |
← Omettre les jours sans daily note. Omettre la colonne Score ou Ressenti si aucune daily note de la semaine ne contient ce champ.
